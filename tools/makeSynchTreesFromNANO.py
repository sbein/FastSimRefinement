...
python3 tools/makeSynchTreesFromNANO.py --fnamekeyword "/nfs/dust/cms/user/beinsam/FastSim/VisitCaloResponse/CMSSW_12_2_3/src/TTbar/Fast/*/step3_inNANOAODSIM.root"
python3 tools/makeSynchTreesFromNANO.py --fnamekeyword "/nfs/dust/cms/user/beinsam/FastSim/VisitCaloResponse/CMSSW_12_2_3/src/T1tttt/Fast/1221/step3_inNANOAODSIM.root"

python3 tools/makeSynchTreesFromNANO.py --fnamekeyword "/nfs/dust/cms/user/beinsam/FastSim/VisitCaloResponse/CMSSW_12_2_3/src/TTbar/FastEstatMean/1221/step3_inNANOAODSIM.root"
...
model = load(open('/nfs/dust/cms/user/gerberni/models/SUSY_model.pkl','rb'))
scaler = load(open('/nfs/dust/cms/user/gerberni/models/SUSY_scaler.pkl', 'rb'))
...
def main():
    ...
    for ifname in range(len(fastsimlist)):
      ...
      FULLNAME = fastsimlist[ifname].replace('/Fast/','/Full/').replace('/FastEstatMean/','/Full/').replace('/FastGenDecays/','/Full/')
